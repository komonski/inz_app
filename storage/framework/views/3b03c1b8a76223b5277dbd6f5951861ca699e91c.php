...
<div class="content--title">
    ...
    <div class="col-xl-6">
        ...
        <ul class="content--title--right--breadcrumb">
            <li><a href="<?php echo e(url('pokoje')); ?>">Klasy</a></li>
            <li class="active"><a href="<?php echo e(url('pokoje/dodaj')); ?>">Dodaj pokój</a></li>
        </ul>
        </div>
    </div>
    </div>
...
<div class="content--main">
    ...
    <div class="col-xl-12">
        ...
        <div class="row">
            ...
            <?php endif; ?>
            <form method="POST" action="<?php echo e(url('pokoje/dodaj')); ?>" >
            <?php echo csrf_field(); ?>
                ...
                <a href="<?php echo e(url('pokoje')); ?>" class="btn-md btn-grey">Anuluj</a>
            </form>
            </div>
        </div>
        </div>
