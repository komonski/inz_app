                            ...
                            <?php if($shedule->shedule_week == $active_week && $shedule->shedule_day == '1'): ?>
                                <li class="single-event" data-start="<?php echo e($shedule->shedule_hour_start); ?>" data-end="<?php echo e($shedule->shedule_hour_end); ?>">
                                  <div class="single-event-center">
                                    <span class="hour"><?php echo e($shedule->shedule_hour_start); ?> - <?php echo e($shedule->shedule_hour_end); ?></span><br/>
                                    <span class="name"><?php echo e($shedule->subject_name); ?></span><br/>
                                    <span class="teacher"><?php echo e($shedule->teacher_name); ?></span><br/>
                                    <span class="room"><?php echo e($shedule->room_name); ?></span><br/>
                                  </div>
                                </li>
                            <?php endif; ?>
